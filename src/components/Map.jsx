    ...
    svg
      ...
      .on("mouseover", function (event) {
        ...
        if (selectedContinent) {
          const continent = Object.keys(continentMapping).find((cont) =>
            continentMapping[cont].includes(arg)
          );
      ...
      if (svgRef.current) {
        ...
        paths.forEach((path) => {
          ...
          if (parent === svg) {
            ...
            console.warn(
              `Path element is not a direct child of the SVG element: ${path}`
            );
          }
        });
      }
