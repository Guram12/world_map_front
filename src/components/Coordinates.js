...
export const countryCoordinates = 
  {
    ...
    GE: { lat: 42.315407, lng: 43.356892 }, // Georgia <3+
    ...
    RU: { lat: 61.52401, lng: 105.318756 }, // Russia BOZI +
    ...
    SS: {lat:7.18438, lng:30.0226}, /// south sudani +
    SO: {lat: 3.90136  , lng:45.87133 }, //// somalia +
